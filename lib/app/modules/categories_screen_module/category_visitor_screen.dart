...
import '../../../colors.dart';
import '../../../visitor_data.dart';

class CategoryvisitorScreen extends StatelessWidget {
  static const id = '/category-tri';
...
//CategoryTripsScreen(this.categeryid,this.categeryTitle);
  ...
  Widget build(BuildContext context) {
    ...
    final selectedTrip = Trip_data.firstWhere((Tri) => Tri.id == categeryId);
